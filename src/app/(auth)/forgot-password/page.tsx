    ...
    return (
      <main className="min-h-screen bg-background">
        <section className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-[600px] items-center px-6 py-16">
          <div className="w-full rounded-3xl border border-[--color-border-primary] bg-background p-8 text-center shadow-[0_10px_40px_rgba(77,156,44,0.08)]">
            <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-[--color-bg-secondary]">
              <MailIcon className="h-8 w-8 text-[--color-primary]" />
            </div>
            <h1 className="text-2xl font-semibold text-[--color-primary-dark]">Check Your Email</h1>
            ...
            <div className="mt-8 flex flex-col gap-3">
              <Link
                href="/login"
                className="rounded-xl bg-[--color-primary] px-8 py-3 text-base font-semibold text-white shadow-[0_10px_25px_rgba(77,156,44,0.25)] transition hover:bg-[--color-primary-dark]"
              >
                Back to Login
              </Link>
              <button
      ...
      <section className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-[1240px] items-center gap-16 px-6 py-16 lg:grid-cols-2">
        ...
        <div className="w-full max-w-md justify-self-center lg:justify-self-end">
          <div className="rounded-3xl border border-[--color-border-primary] bg-background p-8 shadow-[0_10px_40px_rgba(77,156,44,0.08)]">
            <h2 className="text-2xl font-semibold text-[--color-primary-dark]">Reset Password</h2>
            <p className="mt-2 text-sm text-[--color-text-muted]">
                  ...
                  <div className="mt-3">
                    <input
                      ...
                      className={`w-full rounded-xl border bg-background px-4 py-3 text-base font-medium text-[--color-primary-dark] outline-none transition focus:border-[--color-primary] focus:ring-2 focus:ring-[--color-primary]/20 ${
                        touched && error ? 'border-[--color-accent-red]' : 'border-[--color-border-primary]'
                      }`}
