...
export function TestimonialsSection() {
  return (
    <section className="bg-[var(--color-bg-primary)] px-6 pb-24 pt-0 text-zinc-900">
      <div className="mx-auto max-w-[1368px] text-center pt-12 md:pt-16">
        ...
        <div className="relative mt-14 grid gap-6 md:grid-cols-3">
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 rounded-full border border-[var(--color-border-primary)] bg-white/70 p-3 text-[var(--color-primary)] shadow-sm transition hover:bg-white hidden md:block"
          >
            <span aria-hidden="true">‹</span>
          </button>
          <button
            aria-label="Next testimonial"
            className="absolute right-0 top-1/2 -translate-y-1/2 rounded-full border border-[var(--color-border-primary)] bg-white/70 p-3 text-[var(--color-primary)] shadow-sm transition hover:bg-white hidden md:block"
          >
            <span aria-hidden="true">›</span>
          </button>
        ...
        <div className="relative mx-auto mt-12 h-1 w-full max-w-[420px] rounded-full bg-[var(--color-border-primary)]">
